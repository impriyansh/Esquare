jQuery(document).ready(function ($) {
    ...
    var themeName = 'ct_corpress.' + pathname;
    ...
    jQuery("#stylechooser  #styleToggle").click(function () {
        ...
        if(jQuery("body").is(".navbar-sidebar")) {
            setCookie(themeName + '.switcher', $chooser.css('right') == '0px' || $chooser.css('right') == '-1px' ? 'hide' : 'show');
        } else {
    ...
    function store() {
        ...
        setCookie('ct_corpress', r);
    }

    function load() {
        d = getCookie('ct_corpress');
        if (d) {
